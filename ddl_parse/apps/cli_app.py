...
def main_app():
    '''
    This will be exposed as CLI app in setup.py
    :return: Object
    '''
    ...
    while True:
        if choice.upper() == 'FILE':
            ...
            second_file = input(Fore.BLUE + '> Your second .sql file ? ' + Style.RESET_ALL)
            print()
            ...
            if question_.upper()=='YES' or question_.upper()=='Y' or (not question_):
